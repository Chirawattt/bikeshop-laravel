...
<body>
    ...
    <table border="0" width="100%">
        ...
        <tr>
            <td>
                <table border="0" width="100%">
                    <tr><td><strong>ชื่อลูกค้า :</strong> {{ $cust_name }}</td></tr>
                    <tr><td><strong>อีเมล :</strong> {{ $cust_email }}</td></tr>
                </table>
            </td>
    
            <td>
                <table border="0" width="100%">
                    <tr><td><strong>เลขที่:</strong> {{ $po_no }}</td></tr>
                    <tr><td><strong>วันที่:</strong> {{ $po_date }}</td></tr>
                </table>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <h4>หมายเหตุ</h4>
                <ul>
                    <li>ชำระเงินโดยโอนเงินเข้าบัญชี XXX ธนาคาร YYY สาขา ZZZ (ออมทรัพย์)</li>
            ...
            <td align="right">
                ...
                <h1>{{ number_format($total_amount,2) }} บาท</h1> 
            </td>
        </tr>
    </table>
</body>
